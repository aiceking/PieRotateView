package com.zhufaner.pierotateview.test;
...
import com.zhufaner.pierotateview.R;
import com.zhufaner.pierotateview.bean.PieRotateBean;
import com.zhufaner.pierotateview.view.PieRotateView;
...
//        list_numbers.add(400f);
        final List<Integer> list_colors=new ArrayList<>();
        list_colors.add(getResources().getColor(R.color.colorAccent));
        list_colors.add(Color.parseColor("#FF7F00"));
        list_colors.add(Color.parseColor("#CD0000"));
        list_colors.add(Color.parseColor("#228B22"));
        list_colors.add(Color.parseColor("#1C86EE"));
